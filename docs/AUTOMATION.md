...
| `shikisha.browser_state_save(id, "label")` | Save this page's login (its cookies) under a name. Returns how many were saved. Sign in once, then a later rally can load it |
