...
pub struct Mailbox {
    ...
    /// A tab that was waiting for a folder, and the folder it was given
    pub tab_folders: Vec<(usize, String)>,
...
impl Mailbox {
    ...
    pub fn take_tab_folders(&mut self) -> Vec<(usize, String)> {
        std::mem::take(&mut self.tab_folders)
    }
