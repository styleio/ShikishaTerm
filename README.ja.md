...
**この警告は、あなたの手で消せます。** 消すにはコード署名の証明書が要ります。
...
役に立つと思われたら、**[スターを付けてください](https://github.com/styleio/ShikishaTerm)** —— 1秒で終わって、
署名付きビルドの実現にいちばん近づきます。あなたの次に zip を落とす人のために。

ダウンロードしたものを先に確かめたい場合は
...
自分の端末だけ）、黄色は家庭内LAN（同じWi-Fiにいる人全員）。リンク本体は画面に出しません。
